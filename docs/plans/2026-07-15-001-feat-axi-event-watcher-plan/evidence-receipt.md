...
| R8, U4 | Generierte Skill-, Hilfe- und Dokumentationssynchronität | `make skill`; `make lint`; `docs npm run build` | partial_replacement_required | Der Watch-only-Teil erklärt einen vordergründigen Tool-Aufruf korrekt | Die gerenderte Supervisor-Anleitung beschreibt noch Worker-/Resume und muss in U7 zusammen mit Skill, CLI- und Agent-Doku ersetzt und erneut geprüft werden |
...
| U7 | Hook-native Fortsetzung, Heartbeat-Rearming und begrenzte Stale-Geduld | Noch nicht nach den Architekturentscheidungen vom 2026-07-16 implementiert | pending | Keine Completion-Behauptung | Unit-/Harness-Test für statische Reason-Codes, Repository-/Turn-Bindung, Einzel-Timer, Gate-Pause, Budget 1/4/6, Stale-Pause sowie Merge- und Fehler-Handoff; echter sichtbarer Hook-Lauf |
...
Evidence class: partial_local
Evidence: Fokussierte CLI-/IPC-/Registrierungsregressionen, isolierte Race-Pakete, gezielter E2E-Rerun, Lint, Build, Windows-Kompilierung und Docs-Build auf dem Worker-Vorgängerstand.
Proves: Der Watch-Contract und seine lokale, opt-in Registrierungsgrenze sind vor der U7-Ersetzung begrenzt belegt.
Does not prove: Hook-native Fortsetzung, Heartbeat-Rearming, aktuelle Supervisor-Guidance oder dass Smart Commit denselben sichtbaren Codex-Chat über mehrere AXI-Ereignisse begleitet.
Residual risk: Der frühere Worker-/Resume-Pfad muss entfernt, die betroffene Guidance ersetzt und durch einen echten, von Simon überprüften Stop-Hook-Lauf erneut belegt werden.
